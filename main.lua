...
function Main()
	titleBg = display.newImage('title.png', 220, 180)
	playBtn = display.newImage('playBtn.png', 222, 163)
	creditsBtn = display.newImage('creditsBtn.png', 222, 223)
...
function showGameView:tap(e)
	...
	scoreTF = display.newText('0', 80, 35, 'Ariel', 16)
	scoreTF:setTextColor(252, 160, 100)
...
function alert()
	...
	local score = display.newText(scoreTF.text, (display.contentWidth * 0.5), (display.contentHeight * 0.55), 'Courier Bold', 18)
